...
#ifndef CONFIG_WFA /* Avoid Kernel Panic for ML associated STA */
...
#ifdef CONFIG_WFA
	ieee802_11_send_sa_query_req(hapd, sta->addr, trans_id, 1);
#else
...
#else
	eloop_register_timeout(0, timeout * 1000, ap_sta_delayed_1x_auth_fail_cb,
#endif
			       hapd, sta);
}
