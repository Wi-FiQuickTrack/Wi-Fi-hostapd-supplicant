...
#define TDLS_PROHIBIT_CHAN_SWITCH BIT(1)
	...
	int skip_6g_bss_security_check;
#ifdef CONFIG_WFA
	bool ignore_sta_gtk_rekey;
#endif /* CONFIG_WFA */
	struct wpabuf *eapol_m1_elements;
	struct wpabuf *eapol_m3_elements;
	bool eapol_m3_no_encrypt;
	int gtk_kde_random_reserved_bits;
...
#ifdef CONFIG_WFA
	unsigned int rx_ss_support;
	bool tpe_extend;
	bool rnr_extend;
	bool wide_band_cs_extend;
	bool bss_max_idle_extend;
	bool mbssid_extend;
	bool he_capa_extend;
	bool mu_edca_extend;
	bool he_6g_capa_extend;
	bool eht_capa_extend;
	bool eht_oper_extend;
	bool ml_extend;
	bool ext_capa_extend;
	bool eht_capa_res_bits;
	bool eht_oper_res_bits;
	bool eht_capa_unt_bits;
	bool eht_oper_unt_bits;
	bool ml_res_bits;
	bool ml_ctrl_ext_mld_capa_pres_bit;
	bool rnr_res_bits;
	bool he_capa_res_bits;
	bool he_oper_res_bits;
	bool rrm_res_bits;
	bool he_6g_capa_res_bits;
	bool bss_max_idle_res_bits;
	bool capa_info_res_bits;
#endif
